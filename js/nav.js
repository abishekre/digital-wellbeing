...
homebtn.addEventListener('click',function(){
    ...
    navarea.innerHTML = '';
    navarea.innerHTML = '<div><img class="home-img" src="assets/icons/icon128.png" alt="Digital WellBeing Logo">  </div>  <div class="home-text">    <label class="home-head">Digital WellBeing</label>    <label class="home-sub">Make work in Internet work for you</label>  </div>';
});

btn1.addEventListener('click',function(){
    console.log('btn-1');
    navarea.innerHTML='<div id="top">    <form id="newSessionForm">        <div class="newses">            <input id="newSessionName" class="newSessionName" type="text" placeholder="Name of the Session">            <button id="submit-btn" class="submit-btn" value="Save">        </div>    </form></div><div class="mid" id="mid">    </div>';
});
